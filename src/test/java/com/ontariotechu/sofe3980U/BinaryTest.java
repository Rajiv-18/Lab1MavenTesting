...
public class BinaryTest 
{
    ...
    /**
     * Test The or function with two binary numbers, the length of the first argument is more than the second
     */
    @Test
    public void or2()
    {
        Binary binary1=new Binary("1010");
        Binary binary2=new Binary("00");
        Binary binary3=Binary.or(binary1,binary2);
        assertTrue( binary3.getValue().equals("1010"));
    }
    /**
    ...
    /**
     * Test The and function with a binary number and one zero
     */
    @Test
    public void and3()
    {
    ...
    /**
     * Test The multiply function with two binary numbers, the length of the first argument is more than the second
     */
    @Test
